...
cols_lagueables <- c('ctrx_quarter_normalizado',
                     ...
                     'vmr_Visa_mlimitecompra',
                     'mrentabilidad_rank',
                     'mcaja_ahorro_dolares_rank',
                     'thomebanking',
                     'cproductos',
                     'vmr_Master_mlimitecompra',
                     'tcallcenter',
                     'vm_fultimo_cierre',

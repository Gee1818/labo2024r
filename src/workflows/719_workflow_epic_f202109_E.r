...
FEhist_base <- function( pinputexps)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1501_FE_historia_C.r"
  ...
  param_local$Tendencias2$ventana <- 9
...
HT_tuning_epic <- function( pinputexps, bypass=FALSE)
{
  ...
  param_local$bo_iteraciones <- 10 # iteraciones de la Optimizacion Bayesiana

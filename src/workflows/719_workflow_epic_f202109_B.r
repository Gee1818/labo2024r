...
CA_catastrophe_base <- function( pinputexps, metodo )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1202_CA_reparar_dataset_A.r"
...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intrames_manual_B.r"
...
DR_drifting_base <- function( pinputexps, metodo)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1401_DR_corregir_drifting_A.r"
...
FEhist_base <- function( pinputexps)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1501_FE_historia_A.r"
  ...
  param_local$Tendencias2$ema <- TRUE
  param_local$Tendencias2$bbwp <- TRUE
...
FErf_attributes_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1311_FE_rfatributes_A.r"
...
CN_canaritos_asesinos_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1601_CN_canaritos_asesinos_A.r"
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/2101_TS_training_strategy_A.r"

  param_local$future <- c(202109)

  param_local$final_train$undersampling <- 0.4
  param_local$final_train$clase_minoritaria <- c( "BAJA+1", "BAJA+2")
  param_local$final_train$training <- c(202107, 202106, 202103, 202102, 202011, 202010,
    201912, 201911, 201908, 201907)


  param_local$train$training <- c(202105, 202104, 202101, 202012, 202002,
    202001, 201910, 201909, 201906, 201905)
